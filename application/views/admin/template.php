  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-light-primary elevation-4">
      ...
      <div class="bg-primary brand-link">
        <a href="">
          <img src="<?= base_url('assets/images/logo/logomini.png') ?>" alt="Topgear Coffee & Roastery" class="brand-image img-circle elevation-3 bg-white" style="opacity: .8">
          <span class="brand-text font-weight-light">
            <?php if ($this->session->level == 1) { ?>
              Topgear Coffee <?php } else { ?>
              Administrator
            <?php } ?>
          </span>
        </a>
