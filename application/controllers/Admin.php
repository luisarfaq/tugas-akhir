...
class Admin extends CI_Controller
{
	...
	function home()
	{
		if (!empty($this->session->userdata())) {
			...
			$data['title'] = 'Admin - Topgear Coffe & Roastery';
	...
	function kategori_produk()
	{
		...
		$data['title'] = 'Kategori Produk - Topgear Coffe & Roastery';
	...
	function tambah_kategori_produk()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Kategori Produk - Topgear Coffe & Roastery';
	...
	function edit_kategori_produk()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Ubah Produk - Topgear Coffe & Roastery';
	...
	function produk()
	{
		$data['title'] = 'Produk - Topgear Coffe & Roastery';
	...
	function tambah_produk()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Produk - Topgear Coffe & Roastery';
			$data['record'] = $this->model_app->view_ordering('tb_toko_kategoriproduk', 'id_kategori_produk', 'DESC');
	...
	function edit_produk()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit - Topgear Coffe & Roastery';
			$data['supp'] = $this->model_app->view_ordering('tb_toko_supplier', 'id_supplier', 'DESC');
			$data['record'] = $this->model_app->view_ordering('tb_toko_kategoriproduk', 'id_kategori_produk', 'DESC');
	...
	function rekening()
	{
		...
		$data['title'] = 'Rekening - Topgear Coffe & Roastery';
	...
	function tambah_rekening()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Rekening - Topgear Coffe & Roastery';
	...
	function edit_rekening()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Rekening - Topgear Coffe & Roastery';
	...
	function supplier()
	{
		...
		$data['title'] = 'Supplier - Topgear Coffe & Roastery';
	...
	function tambah_supplier()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Supplier - Topgear Coffe & Roastery';
	...
	function edit_supplier()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Supplier - Topgear Coffe & Roastery';
	...
	function konsumen()
	{
		$data['title'] = 'Konsumen - Topgear Coffe & Roastery';
	...
	function edit_konsumen()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Ubah Konsumen - Topgear Coffe & Roastery';
	...
	function detail_konsumen()
	{
		...
		$data['title'] = 'Detail Konsumen - Topgear Coffe & Roastery';
	...
	function pesanan_dikirim()
	{
		...
		$data['title'] = 'Masukan Resi - Topgear Coffe & Roastery';
	...
	function website()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Identitas Website - Topgear Coffe & Roastery';
	...
	function menu()
	{
		...
		$data['title'] = 'Menu Website - Topgear Coffe & Roastery';
	...
	function tambah_menu()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Menu Website - Topgear Coffe & Roastery';
	...
	function edit_menu()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Ubah Menu Website - Topgear Coffe & Roastery';
			$data['record'] = $this->model_menu->menu_utama();
	...
	function logo()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Logo Website - Topgear Coffe & Roastery';
	...
	function slider()
	{
		...
		$data['title'] = 'Slider - Topgear Coffe & Roastery';
	...
	function tambah_slider()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Slider - Topgear Coffe & Roastery';
	...
	function edit_slider()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Slider - Topgear Coffe & Roastery';
	...
	function halaman()
	{
		...
		$data['title'] = 'Halaman - Topgear Coffe & Roastery';
	...
	function tambah_halaman()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Halaman Baru - Topgear Coffe & Roastery';
	...
	function edit_halaman()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Ubah Halaman Baru - Topgear Coffe & Roastery';
	...
	function artikel()
	{
		$data['title'] = 'Artikel - Topgear Coffe & Roastery';
	...
	function tambah_artikel()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Artikel - Topgear Coffe & Roastery';
	...
	function edit_artikel()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Artikel - Topgear Coffe & Roastery';
			$data['tag'] = $this->model_artikel->tag_artikel();
			$data['record'] = $this->model_artikel->kategori_artikel();
	...
	{
		$data['title'] = 'Tag - Topgear Coffe & Roastery';
	...
	function tambah_tag_artikel()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Tag - Topgear Coffe & Roastery';
	...
	function edit_tag_artikel()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Tag - Topgear Coffe & Roastery';
		...
		if (isset($_POST['submit'])) {
			...
			if ($hasil['file_name'] == '' and $this->input->post('b') == '') {
				$data = array(
					...
					'id_alamat' => $this->db->escape_str($this->input->post('h')),
			...
			$data['title'] = 'Edit Pengguna - Topgear Coffe & Roastery';
	...
	function users()
	{
		$data['title'] = 'Manajemen Pengguna - Topgear Coffe & Roastery';
	...
	function tambah_user()
	{
		...
		if (isset($_POST['submit'])) {
			...
			redirect('admin/tambah_user/' . $this->input->post('a'));
		} else {
			$data['title'] = 'Tambah Pengguna - Topgear Coffe & Roastery';
	...
	function profil()
	{
		...
		// $data['record'] = $this->model_app->view_ordering('tb_pengguna', 'username', 'DESC');
		$data['record'] = $this->db->query("SELECT * FROM tb_pengguna ORDER BY level ASC,username ASC")->result_array();
		$this->template->load('admin/template', 'admin/profil/view_profil_view', $data);
	}
	...
	function edit_profil()
	{
		...
		if (isset($_POST['submit'])) {
			...
			redirect('admin/edit_profil/' . $this->input->post('id'));
		} else {
			$data['title'] = 'Edit Pengguna - Topgear Coffe & Roastery';
			$proses = $this->model_app->edit('tb_pengguna', array('username' => $id))->row_array();
			$data = array('rows' => $proses);
			$this->template->load('admin/template', 'admin/profil/view_profil_edit', $data);
		}
	}
	...
	function laporan()
	{
		$data['title'] = 'Laporan Penjualan - Topgear Coffe & Roastery';
	...
	function newsletter()
	{
		...
		$data['title'] = 'Newsletter - Topgear Coffe & Roastery';
	...
	function tambah_newsletter()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$ci->email->from('boyastro768@gmail.com', "Topgear Coffe & Roastery");
			...
			$data['title'] = 'Kirim News Letter - Topgear Coffe & Roastery';
	...
	function lihat_newsletter()
	{
		...
		$data['title'] = 'Detail Berita - Topgear Coffe & Roastery';
	...
	function subscriber()
	{
		$data['title'] = 'Subscriber - Topgear Coffe & Roastery';
